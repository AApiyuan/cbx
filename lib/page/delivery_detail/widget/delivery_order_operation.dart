...
Widget orderOperation() {
  return Container(
    ...
    child: Container(
      ...
      child: Row(children: [
        Expanded(
          child: pText("改/退", ColorConfig.color_ffffff, 28.w,
              width: 230.w, height: 96.w, onTap: () {
        ...
        // pText("转生产", ColorConfig.color_ffffff, 28.w, width: 230.w, height: 96.w, onTap: () {
        //   //跳转生产
        // }),
        // VerticalDivider(
        //   indent: 34.w,
        ...
        Expanded(
          child: GetBuilder<SaleDetailController>(
            builder: (ctl) {
              return pText("去发货", ColorConfig.color_ffffff, 28.w,
                  width: 230.w, height: 96.w, onTap: () {
                //跳转发货
                if (ctl.saleOrder?.configDistribution ==
                    EnumCoverUtils.enumsToString(
                  ...
                  Get.toNamed(ArgUtils.map2String(
                      path: Routes.TRANSFER_DISTRIBUTION_RECORD,
                      arguments: param));
                } else {
                  MethodChannel(ChannelConfig.flutterToNative).invokeMethod(
                      ChannelConfig.methodDelivery, jsonEncode(ctl.saleOrder));
                }
              });
            },
          ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              pText('编辑单据', ColorConfig.color_666666, 28.w,
                                  fontWeight: FontWeight.w600),
                              pSizeBoxH(35.w),
                              pText(
                                  '直接编辑的单据数据', ColorConfig.color_999999, 24.w),
                              pSizeBoxH(15.w),
                              pText('跨天编辑会影响财务统计，请谨慎使用',
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              pText('退欠货（未发过货的货品）', ColorConfig.color_666666,
                                  28.w,
                                  fontWeight: FontWeight.w600),
                              pSizeBoxH(35.w),
                              pText(
                                  '退完直接生成新单据', ColorConfig.color_999999, 24.w),
                              pSizeBoxH(15.w),
                              pText('单据欠货数越少，仓库不增加库存', ColorConfig.color_999999,
                                  24.w,
                                  maxLines: 2),
                            ],
                          ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              pText('退实物（已发过货的货品）', ColorConfig.color_666666,
                                  28.w,
                                  fontWeight: FontWeight.w600),
                              pSizeBoxH(35.w),
                              pText('退完生成新单据', ColorConfig.color_999999, 24.w),
                              pSizeBoxH(15.w),
                              pText('单据欠货数不变，仓库库存增加', ColorConfig.color_999999,
                                  24.w,
                                  maxLines: 2),
                            ],
                          ),
