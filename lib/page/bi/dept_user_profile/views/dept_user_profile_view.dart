...
import 'package:haidai_flutter_module/page/bi/dept_user_profile/widget/dept_user_list.dart';
import 'package:haidai_flutter_module/theme/color.dart';
import 'package:haidai_flutter_module/widget/p_common.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

class DeptUserProfileView extends GetView<DeptUserProfileController> {
  @override
  Widget build(BuildContext context) {
    return WillPopScope(
        child: GetBuilder<DeptUserProfileController>(
            builder: (ctl) {
              return Scaffold(
