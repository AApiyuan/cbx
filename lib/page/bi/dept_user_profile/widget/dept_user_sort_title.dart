                  ...
                  children: [
                    CustomerTab(
                        ...
                        change: (index) {
                          ...
                          if (index == 1) {
                            //欠款客户
                            if (ctl.viewList != "oweAmountCustomer") {
                              ctl.viewList = "oweAmountCustomer";
                              ctl.orderBy = "DESC";
                              ctl.pageNo = 1; //页码

                              ctl.orderByField = "orderOweAmount";
                              ctl.updateRecord();
                            }
                          }
                          if (index == 2) {
                            ...
                            child: Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  width: double.infinity,
                                  alignment: Alignment.centerLeft,
                                  child: pText((ctl.viewList == "sale" || ctl.viewList == "oweGoods") ? "货品" : "客户", 0xb3ffffff, 24.w),
                                )),
                                ...
                                Visibility(visible: ctl.viewList == "oweAmountCustomer", child: sortTitleButton(ctl, "单据结欠", "orderOweAmount")),
                                Visibility(visible: ctl.viewList == "oweAmountCustomer", child: sortTitleButton(ctl, "余额", "balance")),
                                Visibility(visible: ctl.viewList == "oweAmountCustomer", child: sortTitleButton(ctl, "总欠款", "oweAmount")),
...
Widget sortTitleButton(DeptUserProfileController ctl, String name, String filed) {
