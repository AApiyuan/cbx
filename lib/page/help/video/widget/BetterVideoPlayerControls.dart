...
class MyBetterVideoPlayerControls extends StatefulWidget {
  final bool isFullScreen;

  const MyBetterVideoPlayerControls({Key? key, required this.isFullScreen}) : super(key: key);
...
class BetterVideoPlayerControlsState extends State<MyBetterVideoPlayerControls>
    with HideStuff<MyBetterVideoPlayerControls> {
