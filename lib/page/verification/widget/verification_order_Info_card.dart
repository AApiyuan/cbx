...
Widget orderInfoCard() {
  return GetBuilder<VerificationLogic>(builder: (ctl) {
    return Visibility(
        visible: true,
        child: Container(
          ...
          decoration: BoxDecoration(color: Color(ColorConfig.color_ffffff), borderRadius: BorderRadius.all(Radius.circular(5.w))),
          child: Column(
