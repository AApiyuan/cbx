...
class MixSkuSilverView extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _MixSkuSilverViewState();
  }
}

class _MixSkuSilverViewState extends State<MixSkuSilverView> {
  ...
  Widget build(BuildContext context) {
    return SliverList(
      ...
      if (widget.data[index].runtimeType.toString() ==
              "_InternalLinkedHashMap<dynamic, dynamic>" &&
          widget.data[index]['itemType'] == 'title') {
        return title(
            widget.thirdTagName, widget.fourTagName, widget.fiveTagName);
      }
      if (widget.data[index].runtimeType.toString() ==
              "_InternalLinkedHashMap<dynamic, dynamic>" &&
  ...
  Widget title(String thirdTagName, var fourTagName, var fiveTagName) {
    return RepaintBoundary(
      ...
      decoration: const BoxDecoration(
        ...
        border: Border(
            bottom: BorderSide(
                color: const Color(ColorConfig.color_dcdcdc), width: 0.5)),
      ),
      child: Row(
        children: [
          Container(
            ...
            decoration: const BoxDecoration(
              border: Border(
                  right: BorderSide(
                      color: Color(ColorConfig.color_dcdcdc), width: 0.5)),
            ),
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              border: Border(
                  right: BorderSide(
                      color: const Color(ColorConfig.color_dcdcdc),
                      width: 0.5)),
            ),
          ...
          Visibility(
              ...
              child: Container(
                ...
                child: pText(
                    fourTagName.toString(), ColorConfig.color_666666, 24.w),
              )),
          Expanded(
            child: Visibility(
                ...
                child: Container(
                  ...
                  child: pText(
                      fiveTagName.toString(), ColorConfig.color_666666, 24.w),
                )),
          )
        ],
      ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: pText(
                      ...
                      widget.compareTag == 'thirdTag'
                          ? (item[widget.compareTag] != item[widget.comparedTag]
                              ? widget.differentColor
                              : widget.equalColor)
                          : ((widget.showNavigateTag == 'thirdTag' &&
                                  item['thirdTag'] < 0)
                              ? ColorConfig.color_FA6400
                              : widget.thirdTagColor),
                      32.w),
                ),
                Container(
                  width: 147.w,
                  ...
                  decoration: BoxDecoration(
                    border: Border(
                        bottom: BorderSide(
                            ...
                            width: 0.5),
                        right: BorderSide(
                            color: widget.fourTag != null
                                ? const Color(ColorConfig.color_dcdcdc)
                                : const Color(ColorConfig.color_ffffff),
                            width: 0.5)),
                  ),
                  child: pText(
                      ...
                      widget.compareTag == 'fourTag'
                          ? (item[widget.compareTag] != item[widget.comparedTag]
                              ? widget.differentColor
                              : widget.equalColor)
                          : ((widget.showNavigateTag == 'fourTag' &&
                                  item['fourTag'] < 0)
                              ? ColorConfig.color_FA6400
                              : widget.fourTagColor),
                      32.w),
                ...
                Expanded(
                  child: Container(
                    ...
                    child: pText(
                        widget.fiveTag != null
                            ? item['fiveTag'].toString()
                            : "",
                        widget.compareTag == 'fiveTag'
                            ? (item[widget.compareTag] !=
                                    item[widget.comparedTag]
                                ? widget.differentColor
                                : widget.equalColor)
                            : ((widget.showNavigateTag == 'fiveTag' &&
                                    item['fiveTag'] < 0)
                                ? ColorConfig.color_FA6400
                                : widget.fiveTagColor),
                        32.w),
