...
class CoolKeyboard {
  ...
  static ValueNotifier<double> getKeyboardHeightNotifier() {
    return _keyboardHeightNotifier;
  }
        ...
        builder: (ctx) {
          ...
          return ConstrainedBox(
            constraints: BoxConstraints(
                ...
                minWidth: 0,
                maxHeight: _height,
                maxWidth: DeviceUtil.isPad() ? 1536.w : 750.w),
            child: _lastBuildWidget,
          );
        },
      )),
      left: 0,
      width: DeviceUtil.isPad() ? 1536.w : 750.w,
