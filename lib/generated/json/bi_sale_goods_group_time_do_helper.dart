...
biSaleGoodsGroupTimeDoFromJson(BiSaleGoodsGroupTimeDo data, Map<String, dynamic> json) {
...
Map<String, dynamic> biSaleGoodsGroupTimeDoToJson(BiSaleGoodsGroupTimeDo entity) {
