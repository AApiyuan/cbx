...
inventoryHistoryEntityFromJson(InventoryHistoryEntity data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['canceledUserId'] != null) {
		data.canceledUserId = json['canceledUserId'];
	}
	if (json['canceledTime'] != null) {
		data.canceledTime = json['canceledTime'];
	}
	return data;
}

Map<String, dynamic> inventoryHistoryEntityToJson(InventoryHistoryEntity entity) {
