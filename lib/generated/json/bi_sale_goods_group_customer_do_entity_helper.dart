...
biSaleGoodsGroupCustomerDoEntityFromJson(BiSaleGoodsGroupCustomerDoEntity data, Map<String, dynamic> json) {
	if (json['deptId'] != null) {
...
Map<String, dynamic> biSaleGoodsGroupCustomerDoEntityToJson(BiSaleGoodsGroupCustomerDoEntity entity) {
